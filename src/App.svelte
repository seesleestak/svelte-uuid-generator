        ...
        {#if optionsOpen}
          <div class="form-group" on:change={handleRadio}>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="v1" value="v1" checked>
              <label class="form-check-label" for="v1">v1</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="v4" value="v4">
